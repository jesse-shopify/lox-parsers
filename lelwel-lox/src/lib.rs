//! Lelwel-based Lox parser library
//!
//! This library provides a parser for the Lox programming language using the Lelwel LL(1) parser generator.
//!
//! # Example
//!
//! ```
//! use lelwel_lox::parse_program;
//! use lox_ast::Program;
//!
//! let input = r#"print "Hello, world!";"#;
//! let result = parse_program(input);
//! // Parser implementation using Lelwel
//! ```
...
pub const PARSER_NAME: &str = "lelwel";
pub const PARSER_VERSION: &str = "0.8";
pub const PARSER_DESCRIPTION: &str = "Resilient LL(1) parser generator with error recovery";
